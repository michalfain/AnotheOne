...
public class ViewCharts_1 extends AppCompatActivity {
   static ArrayList<String> charts = new ArrayList<String>();
...
//                retrive();
        ...
        lvCharts.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                new AlertDialog.Builder(ViewCharts_1.this)
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                SharedPreferences sharedPreferences = getApplicationContext().getSharedPreferences("com.example.anotheone"
                                        ,Context.MODE_PRIVATE);
                                HashSet<String> set = new HashSet<>(ViewCharts_1.charts);
